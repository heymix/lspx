...
If sys_exam_id<>"" and is_Id(sys_exam_id)  Then
...
End If
	findKey=findKey&" and IS_PRINT_ENTER=1"
%>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onClick="window.location.reload();"><img src="../Images/refresh.gif" width="16" height="16" /></a>
          ...
          反选 <img src="../Images/table.gif" width="14" height="14" /><font><a href="javascript:void(0)"  onclick="openWin()">打印预览</a></td>
        <td width="14"><img src="../Images/tab_07.gif" width="14" height="30" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="9" background="../Images/tab_12.gif">&nbsp;</td>
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post" action="print_view.asp" target="newwindow"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            <th width="5%" height="26">选择</th>
            <th width="6%" height="26">姓名</th>
            <th width="10%" height="26">身份证号</th>
            <th width="9%" height="26">准考证号</th>
            <th width="4%" height="26">性别</th>
            <th width="6%" height="26">所在学校</th>
            <th width="8%" height="26">电话</th>
            <th width="8%" height="26">手机</th>
            <th width="10%" height="26">Email</th>
            <th width="14%" height="26">考试科目</th>
            <th width="6%" height="26">审核</th>
            <th width="6%" height="26">锁定</th>
...
With ors
	...
	.Sql="USER_ID,SCHOOL_ID,SCHOOL,GENDER,REAL_NAME,AGE,EDUCATION,TEL,MOBILE,EMAIL,LAST_LOGIN_TIME,CHECKED,LOCKED,IS_MAKEUP,TRCHECKED$V_EXAMINEE_TEST$1=1 and TEST_ID="&test_id&"  "&findKey&"$TEST_NO asc$USER_ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
...
If  iRecCount<1 Then%>   
          <tr>
            <td height="18"  colspan="13">[没有查到记录！]</div></td>
          </tr>
