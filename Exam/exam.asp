  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onClick="window.location.reload();">&nbsp;</td>
...
With ors
	...
	.Sql="E.ID,S.SCHOOL,E.SCHOOL_ID,E.TEST_CATE,E.EXA_NAME,E.IS_RUN,E.CHECKED,D.KEY_VALUE AS CATE_NAME,D2.KEY_VALUE AS CITY_NAME $T_EXA AS E left join T_SCHOOL AS S on E.SCHOOL_ID=S.ID left join T_DATA_KEY AS D ON E.TEST_CATE=D.ID left Join T_DATA_KEY AS D2 ON E.CITY_ID=D2.ID$1=1 and E.ID="&sys_exam_id&" "&findKey&"$E.ID desc$E.ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
...
Else     
	...
	%>    
          <tr>
            ...
            <td height="18" ><img src="../Images/001.gif" width="14" height="14" />[<a href="javascript:void(0)" onClick="window.location.href='exam_add_school.asp?id=<%=iRs(0,i)%>&TEST_CATE=<%=iRs(3,i)%>'">添加学校</a>] </td>
            </tr>
