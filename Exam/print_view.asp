...
set rs=conn.execute("SELECT USER_ID,SCHOOL_ID,SCHOOL,GENDER,REAL_NAME,AGE,EDUCATION,TEL,MOBILE,EMAIL,LAST_LOGIN_TIME,CHECKED,LOCKED,IS_MAKEUP,TRCHECKED,PHOTO from V_EXAMINEE_TEST where USER_ID in("&user_id_arr&") and test_id="&test_id&" order by TEST_NO asc")
i=0
