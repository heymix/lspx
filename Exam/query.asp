  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><img src="../Images/excel.gif" width="14" height="14" /><font><a href="javascript:void(0)"  onclick="window.location.href='query_exam_excel.asp'+window.location.search;">导出Excel</a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
