...
<table  width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            ...
            <th width="37%" height="26" bgcolor="#006633" style="color:#CCC; height:40px;">及格情况</th>
	...
	%>    
		...
		col6=col6+(totalIsPassNum)
          ...
          <td height="18" ><%=i+1%></td>
           ...
           <tr>
           	<th width="12.5%" bgcolor="#006633" style="color:#CCC; height:40px;">人数</th>
            <th width="12.5%" bgcolor="#006633" style="color:#CCC; height:40px;">及格率%</th>
            <th width="12.5%" bgcolor="#006633" style="color:#CCC; height:40px;">人数</th>
            <th width="12.5%" bgcolor="#006633" style="color:#CCC; height:40px;">及格率%</th>
            <th width="12.5%" bgcolor="#006633" style="color:#CCC; height:40px;">人数</th>
            <th width="12.5%" bgcolor="#006633" style="color:#CCC; height:40px;">及格率%</th>
            ...
            <tr>
           	<td width="12.5%"><%=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=1 and IS_PASS=1 and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)%></td>
            <td width="12.5%"><%isPassNum=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=1 and IS_PASS=1 and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)
            ...
            <td width="12.5%"><%=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=2 and IS_PASS=1  and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)%></td>
            <td width="12.5%"><%isPassNum=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=2 and IS_PASS=1 and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)
								...
								End If
								Response.write perNum*100&"%"%></td>
            <td width="12.5%"><%=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=3 and IS_PASS=1  and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)%></td>
            <td width="12.5%"><%isPassNum=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=3 and IS_PASS=1 and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)
								...
								End If
								Response.write perNum*100&"%"%></td>
            <td width="12.5%"><%=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=4 and IS_PASS=1 and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)%></td>
            <td width="12.5%"><%isPassNum=conn.execute("select count(USER_ID) from V_SCORE where TOPIC_ID=4 and IS_PASS=1 and  SCHOOL_ID="&rs("SCHOOL_ID")&" and TEST_ID="&test_id)(0)
