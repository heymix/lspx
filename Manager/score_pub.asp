        ...
        <label for="SCHOOL_ID">报考学校:</label>
            <select id="SCHOOL_ID" name="SCHOOL_ID" >
                ...
                <%
					...
					sql="select ID,SCHOOL from T_SCHOOL AS S Left Join T_EXA_SCHOOL_RELATION AS ESR on S.ID=ESR.SCHOOL_ID Left Join T_TEST_EXA_RELATION  AS TER on ESR.EXA_ID=TER.EXA_ID where TER.TEST_ID="&test_id&"  order by SCHOOL asc"
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onClick="window.location.reload();"><img src="../Images/save.gif" width="16" height="14" /><a href="javascript:void(0)" onClick="statusPost(0);">发布成绩</a> <img src="../Images/is_uptop.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="statusPost(1);">[取消发布]</a>&nbsp;&nbsp;&nbsp; <img src="../Images/excel.gif" width="14" height="14" /><font><a href="javascript:void(0)"  onclick="window.location.href='examinee_score_export_excel.asp'+window.location.search;">导出Excel</a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
