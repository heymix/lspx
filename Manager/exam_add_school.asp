  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><img src="../Images/back_01.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="window.location='exam.asp'"> 返回</a></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#f3ffe3"  class="tdStyle"><form method="get" id="editForm" name="editForm"  action="?1=1"  style="line-height:28px">
        <input id="operateType" name="operateType" value="0" type="hidden">
        <input value="<%=EXA_ID%>" name="id"  type="hidden">
        <input value="<%=TEST_CATE%>" name="TEST_CATE"  type="hidden">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="30"><img src="../Images/tab_03.gif" width="15" height="30" /></td>
        <td width="275" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/311.gif" width="16" height="16" /> <span class="tbTitle">未在"<%=test_title%>" 中的学校</span></td>
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onClick="window.location.reload();"><img src="../Images/refresh.gif" width="16" height="16" /></a>
          ...
          反选 <img src="../Images/001.gif" width="14" height="14" /><font><a href="javascript:void(0)" onClick="statusPost('6','multi','<%=TEST_CATE%>');">添加</a></font> <img src="../Images/excel.gif" width="14" height="14" /><font><a href="javascript:void(0)">导出Excel</a></font></td>
        <td width="14"><img src="../Images/tab_07.gif" width="14" height="30" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <input value="<%=EXA_ID%>" name="EXA_ID" id="EXA_ID" type="hidden">
        <input value="<%=TEST_CATE%>" name="TEST_CATE" id="TEST_CATE" type="hidden">
          <table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
            <tr>
              <th width="12%" height="26">选择</th>
              <th width="45%" height="26">学校<%If oBy="" or oBy="asc" THen%>
...
With ors
	...
	.Sql="ID,SCHOOL$T_SCHOOL$CHECKED=1 and ID not in (select SCHOOL_ID from T_EXA_SCHOOL_RELATION where TEST_CATE="&TEST_CATE&") "&findKey&" $"&orderKey&"$ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
