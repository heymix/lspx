...
function delExam(status,type,checkType){


		$.post(	"../Public/exam_add_school.asp?status="+status+"&checkType="+checkType+"&operateType="+type, 
				{subBox:checkType,status:"5",EXA_ID:"0"}, 
				function(data,st){
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><img src="../Images/seek.gif" width="16" height="16" /><a href="javascript:void(0)">查询</a> <img src="../Images/001.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="window.location='exam_add.asp'">添加记录</a></td>
    ...
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onClick="window.location.reload();"><img src="../Images/refresh.gif" width="16" height="16" /></a>
          ...
          反选 <img src="../Images/run.gif" width="16" height="14" /><a href="javascript:void(0)" onClick="statusPost('0','multi','0');">审核</a> <img src="../Images/002.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="statusPost('0','multi','1');">反审核</a> <img src="../Images/is_top_2.gif" width="14" height="14" /><a href="javascript:vodi(0)" onClick="statusPost('1','multi','0')">提交</a> <img src="../Images/is_uptop.gif" width="14" height="14" /><a href="javascript:vodi(0)" onClick="statusPost('1','multi','1')">撤回</a> <img src="../Images/refresh_2.gif" width="14" height="14" /><font><!--a href="javascript:void(0)" onClick="statusPost('2','multi','-1');">刷新排序</a></font--> <img src="../Images/083.gif" width="14" height="14" /><font><a href="javascript:void(0)" onClick="statusPost('4','multi','-1');">删除选中</a></font></td>
        <td width="14"><img src="../Images/tab_07.gif" width="14" height="30" /></td>
      </tr>
    </table></td>
  </tr>
      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            ...
            <th width="18%" height="26">考点名称</th>
            <th width="10%" height="26">考点所在学校</th>
            <th width="12%" height="26">审核</th>
            <th width="17%" height="26">提交</th>
            <th width="13%" height="26">考点考试的学校</th>
            <th width="10%" height="26">操作</th>
            </tr>
...
With ors
	...
	.Sql="E.ID,S.SCHOOL,E.SCHOOL_ID,E.TEST_ID,E.EXA_NAME,E.IS_RUN,E.CHECKED $T_EXA AS E left join T_SCHOOL AS S on E.SCHOOL_ID=S.ID$1=1 And E.TEST_ID="&TEST_ID&" "&findKey&"$E.ID desc$E.ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
...
If  iRecCount<1 Then%>   
          <tr>
            <td height="18"  colspan="8">[没有查到记录！]</div></td>
          </tr>
...
Else     
	...
	%>    
          <tr>
            ...
            <td height="18" ><table width="200">
            <%set rs=server.createobject("ADODB.Recordset")
			 sql="select S.ID,S.SCHOOL,S.CHECKED,EXA_ID From T_SCHOOL AS S Right Join T_EXA_SCHOOL_RELATION AS E ON S.ID=E.SCHOOL_ID Where E.TEST_ID="&TEST_ID&" and EXA_ID="&iRs(0,i)
			 rs.open sql,conn,1,3
				...
				Else
					do while not (rs.eof or err)
						Response.write "<tr><td>"&rs("SCHOOL")&"</td><td><img src=""../Images/010.gif"" width=""9"" height=""9"" /><a href=""javascript:void(0)"" onclick=""delExam('5','single','"&rs("ID")&"')"">[移除]</a></td></tr>"
				   	rs.movenext
				   	loop
			  	End If
			   rs.close
            ...
            <td height="18" ><img src="../Images/001.gif" width="14" height="14" />[<a href="javascript:void(0)" onClick="window.location.href='exam_add_school.asp?id=<%=iRs(0,i)%>'">添加学校</a>] <img src="../Images/edit.gif" width="14" height="14" />[<a href="javascript:void(0)" onClick="window.location.href='exam_add.asp?id=<%=iRs(0,i)%>'">编辑</a>]</td>
            </tr>
