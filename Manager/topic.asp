...
function subEdit(){
	...
	if(opType=="0"){
		...
		window.location.href='?sKey='+sKey;
	}
	if(opType=="2"){
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><img src="../Images/seek.gif" width="16" height="16" /><a href="javascript:void(0)" onClick="opType('0','','')">查询</a> <img src="../Images/001.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="window.location.href='topic_add.asp'">添加考试科目</a></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <label style="width:120px"><span id="opName">查询</span> 科目名称：</label>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="30"><img src="../Images/tab_03.gif" width="15" height="30" /></td>
        <td width="275" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/311.gif" width="16" height="16" /> <span class="tbTitle">科目列表</span></td>
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onClick="window.location.reload();"><img src="../Images/refresh.gif" width="16" height="16" /></a>
          ...
          反选  <img src="../Images/083.gif" width="14" height="14" /><font><a href="javascript:void(0)" onClick="delPost('-1','multi');">删除选中</a></font> <img src="../Images/excel.gif" width="14" height="14" /><font><a href="javascript:void(0)">导出Excel</a></font></td>
        <td width="14"><img src="../Images/tab_07.gif" width="14" height="30" /></td>
      </tr>
    </table></td>
  </tr>
      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            ...
            <th width="7%" height="26">序号</th>
            <th width="24%" height="26">科目名称</th>
            <th width="33%" height="26">考试类别</th>
            <th width="14%" height="26">是否实践科目</th>
...
With ors
	...
	.Sql="T.ID,T.TNAME,T.TEST_CATE,D.KEY_VALUE AS TEST_CATE_NAME,T.IS_PRATICE$T_TEST_TOPIC AS T Left Join T_DATA_KEY AS D ON T.TEST_CATE=D.ID$1=1 "&findKey&"$T.ID asc$T.ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
...
Else     
	...
	%>    
          <tr>
            ...
            <td height="18" ><%=getTrue(iRs(4,i))%></td>
            <td height="18" ><img src="../Images/edit.gif" width="14" height="14" />[<a href="javascript:void(0)" onClick="window.location.href='topic_add.asp?id=<%=iRs(0,i)%>'">编辑</a>]</td>
            </tr>
