...
function statusPost(status,type,checkType){
	...
	if (status=="4"){
		...
		$.post(	"../Public/downloadStatus.asp?status="+status+"&checkType="+checkType+"&operateType="+type, 
				$("#listForm").serialize(), 
				function(data,st){
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="550" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/operatePanle.gif" width="16" height="16" /> <span class="tbTitle">操作面板>>下载</span></td>
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><img src="../Images/seek.gif" width="16" height="16" /><a href="javascript:void(0)">查询</a> <img src="../Images/001.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="window.location='download_add.asp'">添加记录</a></td>
      ...
      <tr>
		...
		<select id="CATEGORY" name="CATEGORY">
                ...
                <%
					...
					sql="select ID,KEY_ID,KEY_VALUE from T_DATA_KEY where KEY_ID=2"
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="30"><img src="../Images/tab_03.gif" width="15" height="30" /></td>
        <td width="275" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/311.gif" width="16" height="16" /> <span class="tbTitle">下载列表</span></td>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            <th width="7%" height="26">选择</th>
            <th width="38%" height="26">标题</th>
            <th width="13%" height="26">类别</th>
            <th width="7%" height="26">审核</th>
            <th width="5%" height="26">置顶</th>
             <th width="5%" height="26">权限</th>
            <th width="20%" height="26">发布时间</th>
...
With ors
	...
	.Sql="N.ID,N.CATEGORY,D.KEY_VALUE,N.TITLE,N.CONTENT,N.INFO_TIME,N.CHECKED,N.IS_TOP,N.IS_TOP_TIME,DOWN_LINK,IS_READ$T_DOWNLOAD AS N Left Join T_DATA_KEY AS D ON N.CATEGORY=D.ID $1=1 "&findKey&"$N.ID desc$N.ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
...
Else     
	...
	%>    
          <tr>
            ...
            <td height="18" ><%=getIsRead(iRs(10,i))%></td>
            <td height="18" ><%=Format_Time(FromUnixTime(iRs(5,i),+8),1)%></td>
            <td height="18" ><img src="../Images/edit.gif" width="14" height="14" />[<a href="javascript:void(0)" onClick="window.location.href='download_add.asp?id=<%=iRs(0,i)%>'">编辑</a>]</td>
            </tr>
