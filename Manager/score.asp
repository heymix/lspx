...
isEdit=0
if not(SYS_USER_ID=1 or SYS_USER_ID=181) then
	sql="select IS_EDIT from t_test where id='"&test_id&"'"
...
If SCORE<>"-1" and is_Id(SCORE)  Then
	...
	ElseIf SCORE="1" Then
		findKey=findKey&" and IS_PASS =1"
	ElseIf SCORE="0" Then
		findKey=findKey&" and IS_PASS =0"
	End If
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <select id="IS_MAKEUP" name="IS_MAKEUP" style="width:185px;">
        	<option value="-1">未选择</option>
