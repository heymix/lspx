...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="9" background="../Images/tab_12.gif">&nbsp;</td>
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post" action="print_crs_inside.asp" target="newwindow"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
        <tr>
        	<td colspan="12">开始年<input name="year_start" type="text">月<input name="month_start" type="text"> 结束年<input name="year_end" type="text">月<input name="month_end" type="text">学校<input name="c_school" type="text"></td>
        </tr>
          <tr>
...
With ors
	...
	.Sql="USER_ID,SCHOOL_ID,SCHOOL,GENDER,REAL_NAME,AGE,EDUCATION,TEL,MOBILE,EMAIL,LAST_LOGIN_TIME,CHECKED,LOCKED,IS_MAKEUP,TRCHECKED,CRS_NO,IS_PRINT$V_EXAMINEE_TEST$[CRS_NO] is not null and [CRS_NO]<>'' and TEST_ID="&test_id&"  "&findKey&"$TEST_NO asc$USER_ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
