...
<a href="upload_score.asp">重新上传</a> 请检查下边的导入结果
<script>window.parent.backfn.apply(this,["<%=msg%>"]);</script>
<%else%>

<form action="upload_score.asp" method="post" enctype="multipart/form-data" target="upload" id="upfrm" name="upfrm"> 
