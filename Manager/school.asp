  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="550" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/operatePanle.gif" width="16" height="16" /> <span class="tbTitle">操作面板>>学校管理</span></td>
...
Else     
	...
	%>
            <tr>
              ...
              <td height="18" ><img src="../Images/run.gif" width="14" height="14" />[<%
			If iRs(2,i)=1 Then%><a href="javascript:void(0)" onClick="checkPost('<%=iRs(0,i)%>','single','1');">已审核</a><%
			Else
			%><a href="javascript:void(0)" onClick="checkPost('<%=iRs(0,i)%>','single','0');">未审核</a><%End If%>]</td>
