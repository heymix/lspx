...
function insertPost(){
		...
		$.post(	"../Public/pring_crs_insert.asp", 
				$("#listForm").serialize(), 
				function(data,st){
...
If SCORE<>"-1" and is_Id(SCORE)  Then
	findKey=findKey&" and RESULT <"&SCORE&" and RESULT >=0"
End If
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <select id="SCORE" name="SCORE">
        	<option value="-1">未选择</option>
            <option value="60" <%If SCORE="60" Then Response.write "selected='selected'"%>>0-60</option>
            <option value="90" <%If SCORE="90" Then Response.write "selected='selected'"%>>0-90</option> 
            <option value="90" <%If SCORE="1" Then Response.write "selected='selected'"%>>合格</option>
            <option value="90" <%If SCORE="0" Then Response.write "selected='selected'"%>>不合格</option> 
        </select>
		<br/>
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"> <img src="../Images/save.gif" width="16" height="14"/><a href="javascript:void(0)" onClick="insertPost();">插入已考成绩</a> 设置每页：<a href="javascript:void(0)" onClick="changePageSize('20')" <%If Cstr(resetPage)="20" Then Response.write "style='color:#F00'"%>>[20]</a> <a href="javascript:void(0)"  onclick="changePageSize('40')" <%If Cstr(resetPage)="40" Then Response.write "style='color:#F00'"%>>[40]</a> <a href="javascript:void(0)"  onclick="changePageSize('60')" <%If Cstr(resetPage)="60" Then Response.write "style='color:#F00'"%>>[60]</a>&nbsp;</a> <a href="javascript:void(0)" onClick="window.location.reload();"><img src="../Images/refresh.gif" width="16" height="16" /></a>
          <img src="../Images/save.gif" width="16" height="14"/><a href="javascript:void(0)" onClick="savePost();">保存修改</a> &nbsp;&nbsp;&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
With ors
	...
	.Sql="[USER_ID],[TEST_ID],[TOPIC_ID],[RESULT],[IS_PASS],[IS_MAKEUP],[IS_SCORE],[REAL_NAME],[TNAME],[TITLE],[ID],[IS_PRATICE]$V_SCORE$IS_MAKEUP=1 and TEST_ID="&TEST_ID&" "&findKey&"$TEST_NO asc$USER_ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
