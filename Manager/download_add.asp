...
If id<>"" and isNumeric(id) Then
	...
	sql="SELECT N.ID,CATEGORY,D.KEY_VALUE,TITLE,CONTENT,INFO_TIME,CHECKED,IS_TOP,IS_TOP_TIME,DOWN_LINK,IS_READ FROM T_DOWNLOAD AS N Left Join T_DATA_KEY AS D ON N.CATEGORY=D.ID where N.ID="&ID
	'response.write sql
...
function backfn(fname){
	document.getElementById("DOWN_LINK").value=fname;
}
</script>
</head>
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="550" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/operatePanle.gif" width="16" height="16" /> <span class="tbTitle">操作面板>>添加下载</span></td>
...
<label for="DOWN_LINK">下载地址:</label><input type="text" id="DOWN_LINK" name="DOWN_LINK" value="<%=DOWN_LINK%>" /><br />
<iframe style="top:2px; margin-top:15px; margin-left:80px;" ID="UploadFiles" name="upload" src="upload.asp" frameborder=0 scrolling=no width="430" height="23"></iframe><br>
