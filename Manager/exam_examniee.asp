...
TRCHECKED	 	= Request("TRCHECKED")
If TRCHECKED="1" or TRCHECKED="0"  Then
	findKey=findKey&" and TRCHECKED="&TRCHECKED
End If


IS_MAKEUP	 	= Request("IS_MAKEUP")
If IS_MAKEUP="1" or IS_MAKEUP="0"  Then
	findKey=findKey&" and USER_ID in (select USER_ID From T_TEST_RESULT where IS_MAKEUP="&IS_MAKEUP&" and TEST_ID="&test_id&")"
End If
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <label for="TRCHECKED">报考审核:</label>
        <select id="TRCHECKED" name="TRCHECKED">
        	<option value="-1">未选择</option>
            <option value="0"<%If TRCHECKED="0" Then Response.write "selected='selected'"%>>未审核</option>
            <option value="1"<%If TRCHECKED="1" Then Response.write "selected='selected'"%>>已审核</option>
        </select>
		<br/>
      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post"  action="../Html/examinee_detail.asp"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            ...
            <th width="4%" height="26">姓名</th>
            <th width="11%" height="26">身份证号</th>
            <th width="7%" height="26">准考证号</th>
            <th width="2%" height="26">性别</th>
            <th width="8%" height="26">所在学校</th>
            <th width="8%" height="26">电话</th>
            <th width="7%" height="26">手机</th>
            <th width="9%" height="26">Email</th>
            <th width="8%" height="26">考试科目</th>
            <th width="3%" height="26">审核</th>
            <th width="3%" height="26">锁定</th>
            <th width="6%" height="26">报考审核</th>
            </tr>
...
End With
'Response.write "TEST_ID="&test_id&"  "&findKey
