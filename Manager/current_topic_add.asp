  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"> <img src="../Images/back_01.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="window.location='current_topic.asp'"> 返回</a></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="30"><img src="../Images/tab_03.gif" width="15" height="30" /></td>
        <td width="275" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/311.gif" width="16" height="16" />  <span class="tbTitle">未在"<%=test_title%>" 中的科目</span></td>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            <th width="11%" height="26">选择</th>
            <th width="8%" height="26">序号</th>
            <th width="26%" height="26">科目名称</th>
            </tr>
...
With ors
	...
	.Sql="T.ID,T.TNAME $T_TEST_TOPIC AS T $1=1 and ID Not in(select TOPIC_ID From T_TEST_TOPIC_RELATION where TEST_ID="&TEST_ID&") "&findKey&"$T.ID desc$T.ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
...
If  iRecCount<1 Then%>   
          <tr>
            <td height="18"  colspan="3">[没有查到记录！]</div></td>
          </tr>
