...
function statusPost(status,type,checkType){
	...
	if (isNaN(checkType)){
		...
		$.post(	"../Public/current_topicStatus.asp?status="+status+"&checkType="+checkType+"&operateType="+type, 
				$("#listForm").serialize(), 
				function(data,st){
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"> <img src="../Images/001.gif" width="14" height="14" /><a href="javascript:void(0)" onClick="window.location='current_topic_add.asp'">添加科目</a></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="30"><img src="../Images/tab_03.gif" width="15" height="30" /></td>
        <td width="275" background="../Images/tab_05.gif" class="tdStyle"><img src="../Images/311.gif" width="16" height="16" /> <span class="tbTitle"><%=test_title%>"的科目</span></td>
        <td background="../Images/tab_05.gif" class="tdStyle tdNavMn"><a href="javascript:void(0)" onClick="window.location.reload();"><img src="../Images/refresh.gif" width="16" height="16" /></a>
          ...
          反选  <img src="../Images/002.gif" width="14" height="14" /> <font><a href="javascript:void(0)" onClick="statusPost('5','multi','<%=TEST_ID%>');">取消</a></font>  </td>
        <td width="14"><img src="../Images/tab_07.gif" width="14" height="30" /></td>
      </tr>
    </table></td>
  </tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#f3ffe3"><form id="listForm" name="listForm" method="post"><table class="list_table" width="99%" border="0" align="center" cellpadding="0" cellspacing="1"  >
          <tr>
            <th width="8%" height="26">选择</th>
            <th width="6%" height="26">序号</th>
            <th width="27%" height="26">科目名称</th>
            <th width="22%" height="26">考试日期</th>
            <th width="24%" height="26">考试时间</th>
...
With ors
	...
	.Sql="R.TEST_ID,R.TOPIC_ID,R.EXA_DATE,R.EXA_TIME,T.TNAME$T_TEST_TOPIC_RELATION AS R Left Join T_TEST_TOPIC AS T ON R.TOPIC_ID=T.ID$1=1 and R.TEST_ID="&TEST_ID&" "&findKey&"$R.TEST_ID desc$R.TEST_ID" '字段,表,条件(不需要where),排序(不需要需要ORDER BY),主键ID
End With
	...
	%>    
          <tr>
            <td height="18" ><div align="center" >
              <input name="subBox" type="checkbox" value="<%=iRs(1,i)%>" />
            </div></td>
            <td height="18" ><%=i+1%></td>
            <td height="18" ><%=iRs(4,i)%></td>
            <td height="18" ><%=format_time(FromUnixTime(iRs(2,i),+8),2)%></td>
            <td height="18" ><%=iRs(3,i)%></td>
            <td height="18" ><img src="../Images/edit.gif" width="14" height="14" />[<a href="javascript:void(0)" onClick="window.location.href='current_topic_reEdit.asp?id=<%=iRs(1,i)%>'">编辑</a>]</td>
            </tr>
